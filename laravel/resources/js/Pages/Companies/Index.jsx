...
class CompaniesIndex extends Component {
    ...
    renderCompanies() {
        return this.state.companies.map(company => <tr key={company.id}>
            ...
            <td className="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap flex justify-end">
        ...
        return (
            <div className="overflow-hidden overflow-x-auto p-6 bg-white border-gray-200">
                <div className="flex place-content-end mb-4">
                    <NavLink to="/companies/create" className="px-4 py-2 rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                        Create
                    </NavLink>
                </div>
